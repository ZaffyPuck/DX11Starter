...
DXCore::~DXCore()
{
	...
	delete& DX12Utility::GetInstance();
}
...
HRESULT DXCore::InitDirect3D()
{
	...
	{
		DX12Utility::GetInstance().Initialize(
			device,
			commandList,
			commandQueue,
			commandAllocator);
...
void DXCore::UpdateTitleBarStats()
{
	...
	{
	case D3D_FEATURE_LEVEL_12_1: output << "	D3D 12.1"; break;
	case D3D_FEATURE_LEVEL_12_0: output << "	D3D 12.0"; break;
