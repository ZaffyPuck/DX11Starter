...
public:
	...
	virtual void DrawRT(float deltaTime, float totalTime) = 0;
...
protected:
	...
	D3D12_CPU_DESCRIPTOR_HANDLE rtvHandles[backBufferCount];
	D3D12_CPU_DESCRIPTOR_HANDLE dsvHandle;

	Microsoft::WRL::ComPtr<ID3D12Resource> backBuffers[backBufferCount];
