...
void Game::LoadAssetsAndCreateGameObjects()
{
	...
	std::shared_ptr<Material> groundMaterial = std::make_shared<Material>(pipelineState, grey3);
	std::shared_ptr<GameObject> ground = std::make_shared<GameObject>(cubeMesh, groundMaterial);
	ground->GetTransform()->SetScale(50,0.2,50);
	ground->GetTransform()->SetPosition(0, -0.1, 0);
	std::shared_ptr<Material> torusMaterial = std::make_shared<Material>(pipelineState, white3);
	...
	std::shared_ptr<Material> sphere1Material = std::make_shared<Material>(pipelineState, GetRandomFloat3());
	...
	std::shared_ptr<Material> helix1Material = std::make_shared<Material>(pipelineState, GetRandomFloat3());
	...
	std::shared_ptr<Material> cube1Material = std::make_shared<Material>(pipelineState, GetRandomFloat3());
	...
	std::shared_ptr<Material> cone1Material = std::make_shared<Material>(pipelineState, GetRandomFloat3());
	...
	{
		std::shared_ptr<Material> sphereMaterial = std::make_shared<Material>(pipelineState, GetRandomFloat3());
...
void Game::DrawRT(float deltaTime, float totalTime)
{
	...
	// Raytrace
	//RaytracingHelper::GetInstance().CreateTopLevelAccelerationStructureForScene(staticGameObjects);
	//RaytracingHelper::GetInstance().CreateTopLevelAccelerationStructureForScene(dynamicGameObjects);
	RaytracingHelper::GetInstance().CreateTopLevelAccelerationStructureForScene(gameObjects);
	RaytracingHelper::GetInstance().Raytrace(camera, currentBackBuffer);
