...
#include <d3d11.h>
#include <string>
#include <wrl/client.h> // Used for ComPtr - a smart pointer for Componenet Object Models (COM) objects
...
public:
	...
	static DXCore* DXCoreInstance; // allows WindowProc to talk to the game object - could make a singleton
